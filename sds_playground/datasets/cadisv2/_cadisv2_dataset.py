...
class CaDISv2_Dataset(data.Dataset):
    ...
    def __init__(self,
        ...
        img_file_list = natsorted(glob.glob(str(root / f"/Video*/Images/*.png")))
        label_file_list = natsorted(glob.glob(str(root / f"/Video*/Labels/*.png")))
        ...
        # shuffled_image_files, shuffled_label_files, shuffled_graph_files = zip(*combined_file_list)
        ...
        if mode == 'train':
            img_file_list, label_file_list, graph_file_list = (shuffled_image_files[:train_end],
                                                               shuffled_label_files[:train_end],
                                                               None)
        elif mode == 'val':
            img_file_list, label_file_list, graph_file_list = (shuffled_image_files[train_end:val_end],
                                                               shuffled_label_files[train_end:val_end],
                                                               None)
        elif mode == 'test':
            img_file_list, label_file_list, graph_file_list = (shuffled_image_files[val_end:],
                                                               shuffled_label_files[val_end:],
                                                               None)
        elif mode == 'full':
            img_file_list, label_file_list, graph_file_list = (shuffled_image_files,
                                                               shuffled_label_files,
                                                               None)
        else:
