...
from sds_playground.datasets.cataract1k.cataract1ksegm_dataset import Cataract1kSegmentationDataset
...
for n in range(N):
    ...
    #save_image(tensor=sample[n], fp=f'Cataract1k_example_{n}_img.png')
    #save_image(tensor=rgb_label[n], fp=f'Cataract1k_example_{n}_mask.png')
